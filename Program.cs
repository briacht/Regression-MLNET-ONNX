...
namespace RegressionMNETONNX
{
    class Program
    {
        private static string TRAIN_DATA_FILEPATH = @"taxi-fare-train.txt";
        private static string TEST_DATA_FILEPATH = @"taxi-fare-test.txt";
        ...
        static void Main(string[] args)
        {
            ...
            // Set the training algorithm and add to pipeline
